...
export default function nominal(props: NominalInterface) {

const {_id, coinName, coinQuantity, price} = props

  return (
        <label key={_id} htmlFor={_id} className="col-lg-4 col-sm-6 ps-md-15 pe-md-15 pt-md-15 pb-md-15 pt-10 pb-10">
          <input
            className="d-none"
            type="radio"
            id={_id}
